...
class TestAzureOpenAIProvider:
    ...
    def test_provider_initialization(self):
        ...
        provider = AzureOpenAIProvider(
            api_key="test-key", azure_endpoint="https://test-resource.openai.azure.com/", api_version="2024-02-01"
        )
    ...
    def test_provider_initialization_missing_endpoint(self):
        ...
        with pytest.raises(ValueError, match="Azure OpenAI endpoint is required"):
            AzureOpenAIProvider(api_key="test-key", azure_endpoint="", api_version="2024-02-01")
    ...
    def test_provider_initialization_invalid_endpoint_protocol(self):
        ...
        with pytest.raises(ValueError, match="Azure OpenAI endpoint must use HTTPS"):
            AzureOpenAIProvider(
                api_key="test-key", azure_endpoint="http://test-resource.openai.azure.com/", api_version="2024-02-01"
            )
    ...
    def test_validate_base_url_warning(self):
        ...
        with patch("providers.azure_openai.logger") as mock_logger:
            provider = AzureOpenAIProvider(
                api_key="test-key", azure_endpoint="https://custom.example.com/", api_version="2024-02-01"
            )
