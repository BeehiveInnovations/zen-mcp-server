"""
Tests for the ConsensusWorkflow tool using WorkflowTool architecture.
"""
...
from tools.consensusworkflow import ConsensusWorkflowRequest, ConsensusWorkflowTool
from tools.models import ToolModelCategory


class TestConsensusWorkflowTool:
    """Test suite for ConsensusWorkflowTool using WorkflowTool architecture."""

    def test_tool_metadata(self):
        """Test basic tool metadata and configuration."""
        tool = ConsensusWorkflowTool()

        assert tool.get_name() == "consensusworkflow"
    ...
    def test_request_validation_step1(self):
        ...
        step1_request = ConsensusWorkflowRequest(
    ...
    def test_request_validation_later_steps(self):
        ...
        step2_request = ConsensusWorkflowRequest(
    ...
    def test_request_validation_duplicate_model_stance(self):
        ...
        valid_request = ConsensusWorkflowRequest(
    ...
    def test_prepare_step_data(self):
        ...
        tool = ConsensusWorkflowTool()
        request = ConsensusWorkflowRequest(
            step="Test step",
            step_number=1,
            total_steps=3,
            next_step_required=True,
