...
from .test_plannerworkflow_validation import PlannerWorkflowValidationTest
...
TEST_REGISTRY = {
    ...
    "plannerworkflow_validation": PlannerWorkflowValidationTest,
