...
from .test_testgenworkflow_validation import TestGenWorkflowValidationTest
...
TEST_REGISTRY = {
    ...
    "testgenworkflow_validation": TestGenWorkflowValidationTest,
