"""
ConsensusWorkflow tool - Step-by-step multi-model consensus with expert analysis
...
class ConsensusWorkflowRequest(WorkflowRequest):
...
class ConsensusWorkflowTool(WorkflowTool):
    """
...
of the evidence, even when it strongly points in one direction.""",
    ...
    def get_workflow_request_model(self):
        ...
        return ConsensusWorkflowRequest
