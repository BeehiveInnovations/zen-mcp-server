...
class AnalyzeWorkflowTool(WorkflowTool):
    """
    ...
    def get_required_actions(self, step_number: int, findings: str, total_steps: int) -> list[str]:
    ...
    def should_call_expert_analysis(self, consolidated_findings, request=None) -> bool:
        ...
        return (
            ...
            or len(consolidated_findings.findings) >= 1
        )
    ...
    def prepare_step_data(self, request) -> dict:
        ...
        step_data = {
            ...
            "issues_found": [],  # Not used in analyze workflow  
    ...
    def get_analyze_step_guidance(self, step_number: int, request) -> dict[str, Any]:
        ...
        required_actions = self.get_required_actions(step_number, request.findings, request.total_steps)
    ...
    def customize_workflow_response(self, response_data: dict, request) -> dict:
        ...
        # Map complete_analyzeworkflow to complete_analysis
