"""
Debug Workflow tool - Root cause analysis and debugging assistance with systematic investigation

This is a migration of the original debug tool to the new WorkflowTool architecture.
It maintains identical behavior while leveraging the new base classes for code reduction.
"""
...
class DebugWorkflowTool(WorkflowTool):
    """
    Debug workflow tool using the new architecture.

    Provides identical behavior to the original debug tool while leveraging
    the WorkflowTool base class for significant code reduction.
    """
