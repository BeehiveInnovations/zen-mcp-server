...
class TestGenWorkflowRequest(WorkflowRequest):
...
class TestGenWorkflowTool(WorkflowTool):
    """
    ...
    def customize_workflow_response(self, response_data: dict, request) -> dict:
        ...
        # Map complete_testgenworkflow to complete_test_generation
